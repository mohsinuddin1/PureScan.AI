...
const locales = ['ar', 'ar-MA', 'cs', 'da', 'de', 'el', 'es', 'fr', 'it', 'ja', 'ko', 'lt', 'lv', 'nb', 'nl', 'no', 'pl', 'pt', 'ro', 'ru', 'sv', 'tr', 'zh', 'bg']; // 24 locales, English makes 25.
...
async function run() {
    const slug = '32-why-are-my-eyelashes-falling-out.mdx';
    ...
    for (const match of htmlMatches) {
        // match[2] contains the inner HTML
        // remove inner tags for translation or translate as is.
        // google translate handles basic html tags if we pass them, but to be safe, we translate the inner string.
