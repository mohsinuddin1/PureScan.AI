export default function handler(req, res) {
  ...
  if (/iPad|iPhone|iPod|Macintosh|Mac OS/i.test(userAgent)) {
    ...
    res.redirect(302, 'https://play.google.com/store/apps/details?id=com.pureai.com&referrer=utm_source%3Dfriends_family%26utm_medium%3Dsocial_share%26utm_campaign%3Dresult_share');
  }
}
