const apiKey = process.env.sandbox_paddle;

if (!apiKey) {
  console.error("sandbox_paddle not found in environment variables. Make sure to run with --env-file=.env");
  process.exit(1);
}
...
async function createPaddlePackage() {
  try {
    // 1. Create a Product
    console.log("Creating Paddle Product in Sandbox...");
